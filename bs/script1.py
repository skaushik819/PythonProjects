...
b1 = Button(text="ViewAll",width=12,command=View_command)
b1.grid(row=2,column=3)

b2 = Button(text="SearchEntry",width=12,command=search_command)
b2.grid(row=3,column=3)

b3 = Button(text="AddEntry",width=12,command=add_command)
